...
const sliderImages = [
  'https://images.unsplash.com/photo-1589395937658-0557e7d89fad?q=80&w=2012&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Image 1
  'https://images.unsplash.com/photo-1640077596566-d53aa00e99fc?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Image 2
  'https://images.unsplash.com/photo-1576004257167-17afad35dde2?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Image 3
  'https://images.unsplash.com/photo-1528109901743-12b16e05eedf?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Image 4
];
const testimonials = [
  {
    name: 'Alice Green',
...
const LearningPlans = () => {
  ...
  return (
    <div className='bg-gradient-to-b from-white to-blue-50 min-h-screen pt-8 pb-20 px-4 md:px-8 lg:px-16'>
      <motion.div
        initial='hidden'
        animate='visible'
      ...
      >
        <motion.div variants={fadeIn} className='mb-10 text-center'>
          <h2 className='text-4xl font-bold text-gray-800 mb-3'>My Learning Plans</h2>
          <p className='text-gray-600'>Track, manage, and grow your personalized learning journey.</p>
        </motion.div>
        ...
        <div>
          ...
          <motion.div
            className='overflow-hidden rounded-lg shadow-md h-72'
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
